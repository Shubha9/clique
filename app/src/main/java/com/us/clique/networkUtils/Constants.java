...
public class Constants {
    ...
    public  static final String OPT = PACKAGE_NAME + "OTP";
    public static final String TITLE = "title";
    public static final String URL = "url";
    public static final String PRIVACY_POLICY = " https://staging.cliqueapp.us/privacy-policy";
    public static final String TOS = "https://staging.cliqueapp.us/terms-conditions";
