...
public class EventsAroundYouModle {
    ...
    public class ClonedUser {
        ...
        @SerializedName("cloned_user_id")
        @Expose
        private String clonedUserId;

        public String getClonedUserId() {
            return clonedUserId;
        }

        public void setClonedUserId(String clonedUserId) {
            this.clonedUserId = clonedUserId;
        }
    ...
    public class Datum {
        ...
        @Expose
        private List<ClonedUser> clonedUsers = null;
        @SerializedName("age")
        @Expose
        private Integer age;
        ...
        public List<ClonedUser> getClonedUsers() {
            return clonedUsers;
        }

        public void setClonedUsers(List<ClonedUser> clonedUsers) {
