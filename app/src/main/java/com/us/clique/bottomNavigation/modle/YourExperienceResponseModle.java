...
public class YourExperienceResponseModle implements Serializable {
    ...
    @SerializedName("data")
    @Expose
    private List<EventDescription> data = null;
    ...
    public List<EventDescription> getData() {
        return data;
    }

    public void setData(List<EventDescription> data) {
        this.data = data;
    }
    public class EventDescription implements Serializable  {
        ...
        @SerializedName("EventDateFormat")
        @Expose
