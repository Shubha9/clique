...
public class MessagesRequestAdapter extends RecyclerView.Adapter<MessagesRequestAdapter.MyViewHolder> implements Filterable {
    Context mContext;
    ...
    public MessagesRequestAdapter(Context mContext, ArrayList<RequestsResponceModle.Datum> requestModles,RequestsFragment requestsFragment) {
