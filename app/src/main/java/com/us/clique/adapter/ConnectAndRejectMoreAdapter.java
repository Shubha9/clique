...
public class ConnectAndRejectMoreAdapter extends RecyclerView.Adapter<ConnectAndRejectMoreAdapter.MyViewHolder> implements Filterable {
    Context mContext;
    ...
    public ConnectAndRejectMoreAdapter(Context mContext, ArrayList<ConnectAndRejectModle.Datum> requestModles, RequestsFragment requestsFragment) {
    ...
    @NonNull
    @Override
    public ConnectAndRejectMoreAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ConnectAndRejectMoreAdapter.MyViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull ConnectAndRejectMoreAdapter.MyViewHolder holder, int position) {
