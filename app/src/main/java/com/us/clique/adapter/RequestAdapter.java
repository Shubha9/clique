...
public class RequestAdapter extends RecyclerView.Adapter<RequestAdapter.MyViewHolder> implements Filterable {
    ...
    public RequestAdapter(Context mContext, ArrayList<RequestsResponceModle.Datum> requestModles,EventsAroundYouDetailsInterface eventsAroundYouDetailsInterface) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.binding.tvAccept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                holder.binding.tvAccept.setBackground(ContextCompat.getDrawable(mContext,R.drawable.message_btn_bg));
                holder.binding.tvReject.setBackground(ContextCompat.getDrawable(mContext,R.drawable.learnfun_btn_bg));
                holder.binding.tvReject.setTextColor(ContextCompat.getColor(mContext, R.color.tab_text));
                holder.binding.tvAccept.setTextColor(ContextCompat.getColor(mContext, R.color.white));
            }
        });
        ...
        holder.binding.tvReject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                holder.binding.tvReject.setBackground(ContextCompat.getDrawable(mContext,R.drawable.message_btn_bg));
