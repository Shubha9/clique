...
public class RequestedAdapter extends RecyclerView.Adapter<RequestedAdapter.MyViewHolder> implements Filterable {
    Context mContext;
    ArrayList<RequestsResponceModle.Datum> chatsModles = new ArrayList<>();
    LayoutInflater layoutInflater;
    String notification;
    GotoMessagesList gotoMessagesList;
    private List<RequestsResponceModle.Datum> filterlist=null;

    public RequestedAdapter(Context mContext, ArrayList<RequestsResponceModle.Datum> chatsModles,GotoMessagesList gotoMessagesList) {
        this.mContext = mContext;
        this.chatsModles = chatsModles;
        filterlist = new ArrayList<>(chatsModles);
        this.gotoMessagesList = gotoMessagesList;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        }else if (chatsModle.getRequestingStatus().equals("0")){
      ...
      /*  notification = chatsModle.getNotification();
        ...
        holder.binding.rlMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                gotoMessagesList.gotoMessagesList(position);
            }
        });
    }
